...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::chat::feed_image,
            api::chat::feed_text,
            // ── 玩家档案（解耦玩家与 AI，纯 DB 多卡）──
            api::player::get_player_profile,
            api::player::set_player_profile,
            api::player::get_player_persona,
            api::player::set_player_persona,
            api::player::get_player_profiles,
            api::player::set_active_player_card,
            api::player::create_player_card,
            api::player::delete_player_card,
