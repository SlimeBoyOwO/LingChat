...
pub fn register(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    ...
    builder.invoke_handler(tauri::generate_handler![
        ...
        api::workbuddy::workbuddy_auth_status,
        api::workbuddy::workbuddy_start_login,
        api::workbuddy::workbuddy_poll_login,
        api::workbuddy::workbuddy_logout,
        api::workbuddy::workbuddy_get_quota,
