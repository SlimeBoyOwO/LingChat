...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260817_000001_create_player_profile::Migration),
            Box::new(m20260903_000001_ensure_player_profile::Migration),
        ]
    }
}
...
pub mod m20260817_000001_create_player_profile;
pub mod m20260903_000001_ensure_player_profile;
