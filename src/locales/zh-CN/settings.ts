export default {
  ...
  sherpa: {
    title: 'Sherpa-ONNX 语音',
    models: '模型列表',
    noModels: '暂无可用的 Sherpa-ONNX 模型',
    manageModels: '打开模型目录',
    modelConfig: '模型配置',
    modelType: '模型类型',
    language: '语言',
    ...
    pitch: '音调',
    zeroShot: '零样本声音克隆',
    zeroShotDesc: '上传一段参考音频，模型将模仿该声音的音色进行合成',
    refLoaded: '已加载参考音频',
    refNone: '未选择音频',
    refChange: '更换',
    refPick: '选择音频',
    refClear: '清除',
    refText: '参考文本 (可选)',
    refTextPlaceholder: '输入参考音频对应的文本内容，可提升克隆效果',
    test: '试听测试',
    testPlaceholder: '输入测试文本',
    synthesizing: '合成中...',
    listen: '试听',
    noModelHint: '请先选择一个模型',
  },
  log: {
    title: '日志',
    resume: '继续',
  ...
  characterInfo: {
    ...
    fields: {
      ...
      // Sherpa-ONNX 配置
      sherpaOnnxTitle: 'Sherpa-ONNX 语音设置',
      sherpaOnnxModelName: '模型名称',
      sherpaOnnxModelPath: '模型路径',
      sherpaOnnxModelType: '模型类型',
      sherpaOnnxLanguage: '语言',
      sherpaOnnxVoice: '音色',
      sherpaOnnxUseGpu: '使用GPU加速',
      sherpaOnnxParameters: '模型参数',
      sherpaOnnxSpeed: '语速',
      sherpaOnnxPitch: '音调',
      sherpaOnnxRefAudio: '参考音频 (零样本克隆)',
      sherpaOnnxRefText: '参考文本 (可选)',
      sherpaOnnxRefTextPlaceholder: '输入参考音频对应的文本内容，可提升克隆效果',
      noSherpaModel: '未安装任何 Sherpa-ONNX 模型（请先在 Sherpa 设置中下载）',
      notInstalled: '未安装',
      pickFile: '选择音频',
      clearFile: '清除',
