export default {
  ...
  playerProfile: {
    ...
    createProfile: "新建人设",
    deleteProfile: "删除人设",
    confirmDelete: "确认删除该人设？",
    profileIdHint: "人设卡 ID 会按昵称自动生成，稳定可读，可直接用作剧本 persona_id。",
    profileNameRequired: "请输入新人设的昵称",
    cannotDeleteActive: "不能删除当前激活人设，请先切换到其它人设",
    profileNamePlaceholder: "玩家名称",
    userPrompt: "人格/设定",
    userPromptPlaceholder:
      "例如：她叫阿黎，性格温柔但有点毒舌，喜欢烘焙和猫。AI 会据此调整与你的互动方式。",
    userPromptHint:
      "告诉 AI 屏幕对面的你是什么样的人（身份/性格/喜好等），可帮助 AI 更贴合你地回应。",
    playerInfo: "简介 / 一句话人设",
    playerInfoPlaceholder: "一句话介绍你自己，例如：一位喜欢冒险的程序员。",
    promptExample: "说话风格示例",
    promptExamplePlaceholder: "可选：给 AI 一些你说话风格的参考示例，帮助它更自然地模仿你的语气。",
    noInfo: "暂未填写简介",
    edit: "编辑",
    cancel: "取消",
    saving: "保存中...",
    modalTitle: "编辑玩家身份卡",
    modalSubtitle: "复用 AI 角色卡的编辑体验，但只保留玩家身份相关设置",
    save: "保存玩家档案",
    saved: "玩家档案已保存",
    tabs: {
      basic: "基础",
