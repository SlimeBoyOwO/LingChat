export default {
  ...
  background: {
    ...
    lighting: {
      ...
      sourceTool: "插件或助手",
      sourcePanel: "设置面板",
      overriddenHint: "灯光正由「{who}」临时控制；点下方任一预设会立刻取消它并接管",
      clearRuntime: "取消临时灯光",
      clearRuntimeFailed: "取消临时灯光失败",
      takenOver: "已接管灯光：临时灯光已取消，现在按你选的预设打光",
      switchesTitle: "分项开关",
      switchesHint: "只会关掉对应效果，不会改动场景或预设自带的强度",
      overlay: "光照叠加层（整体染色）",
      ...
      custom: {
        ...
        delete: "删除",
        newPreset: "＋ 自定义光影",
        newPresetDesc: "自己调一盏灯，存进「我的预设」长期套用",
        savedOk: "已存进「我的预设」，并设为全局灯光：{name}",
