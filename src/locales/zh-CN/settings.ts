export default {
  ...
  advanceOther: {
    ...
    fields: {
      ...
      embedding: {
        ...
        model_dir: '嵌入模型目录（留空时默认 data/third_party/embedding/，打包版自动回退资源目录内置模型，相对路径按数据目录解析）',
  ...
  tts: {
    ...
    cosyvoice: {
      ...
      importHint: '时长建议 10–20 秒，支持 wav / mp3，采样率不低于 16kHz，所选参考音频语言必须与实际音频语言一致，单人清晰说话，无背景音乐或噪音',
