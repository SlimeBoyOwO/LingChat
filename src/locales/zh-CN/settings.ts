export default {
  ...
  plugins: {
    ...
    items: {
      lighting_studio: {
        name: "光影工坊",
        description: "用一句话描述当前气氛，自动为立绘和背景打光（暖窗光 / 冷月夜 / 逆光剪影等）",
      },
    },
    resourcesTitle: "携带资源",
  ...
  background: {
    ...
    lighting: {
      ...
      lowPerf: "低性能模式",
      lowPerfHint: "只停用呼吸动画等持续动效，静态光影照常保留",
      // 内置光影预设的名字/说明/心情关键词。单一真相源在 Rust 的 lighting_store，
      // 这里只负责显示翻译；查不到词条就回落后端原文，所以自建预设永远显示自己起的名字。
      presets: {
        warm_window: {
          name: "暖窗光",
          description: "午后窗边斜射的暖光，高光偏琥珀、阴影偏青蓝，接近 eden 室内演出",
        },
        backlight_silhouette: {
          name: "逆光剪影",
          description: "强背光、人物压暗、边缘发白，适合登场与告白镜头",
        },
        moonlit_night: {
          name: "冷月夜",
          description: "月光冷蓝、暗部压黑、轻微 bloom，适合夜晚谈心",
        },
        dusk_sunset: { name: "黄昏", description: "低角度橙紫渐变天光，暖冷交界明显" },
        candlelight: {
          name: "烛光",
          description: "小范围暖光源 + 快速呼吸，适合停电 / 祭典 / 深夜对坐",
        },
        neon_night: { name: "霓虹夜", description: "粉蓝霓虹撞色、强 bloom、彩色分离" },
        morning_soft: {
          name: "清晨柔光",
          description: "高亮低对比的柔和晨光，适合新的一天开场",
        },
        overcast_gray: {
          name: "阴天平光",
          description: "去饱和、几乎无方向，情绪低落的留白",
        },
        rainy_gloom: {
          name: "雨雾",
          description: "冷灰蓝压暗 + 大范围柔光，配合 Rain 特效",
        },
        snow_bright: { name: "雪地强光", description: "高亮冷白 + 强 bloom，配合 Snow 特效" },
        forest_dapple: { name: "林间光斑", description: "绿叶滤下的黄绿光斑，呼吸幅度较大" },
        classroom_noon: {
          name: "正午教室",
        ...
        stage_spotlight: {
          name: "舞台聚光",
          description: "小范围顶光 + 重暗角，背景几乎全黑",
        },
        screen_glow: {
          name: "屏幕冷光",
          description: "自下而上的青蓝冷光 + 快呼吸，深夜电脑前",
        },
        thriller_red: { name: "危险红光", description: "单侧血红 + 心跳式呼吸，冲突与危机" },
        dream_pastel: { name: "梦幻粉彩", description: "粉紫低对比 + 强 bloom，回忆与梦境" },
        golden_hour: { name: "黄金时刻", description: "极低角度浓橙侧光，轮廓光最强" },
        night_ambient: {
          name: "夜室内",
          description: "极暗环境 + 微弱冷光源，深夜房间常态",
        },
        sepia_memory: { name: "旧照片", description: "棕褐去色 + 重暗角，闪回与老照片段落" },
      },
      moodTags: {
        afternoon: "午后",
        indoor: "室内",
      ...
      select: {
        searchPlaceholder: "搜索名称、描述或心情关键词",
        empty: "没有匹配的预设",
        newPreset: "＋ 新建我的预设",
        customGroup: "我的预设",
        builtinGroup: "内置预设",
      ...
      custom: {
        ...
        edit: "编辑",
        delete: "删除",
        savedOk: "已存进「我的预设」，并设为默认光影：{name}",
        deleteConfirm: "确定删除光影预设「{name}」？删除后无法恢复。",
        deleteFailed: "删除失败：{msg}",
      },
      editor: {
        titleNew: "自定义光影",
        titleEdit: "编辑光影预设",
        namePlaceholder: "给这套灯光起个名字（最多 24 字）",
        descriptionPlaceholder: "一句话说明这套灯光的感觉（选填）",
        moodPlaceholder: "适用心情，用空格分隔，例如：安静 思念 夜晚",
        moodHint: "名字和心情关键词会让助手在对话里认得这套灯，说「换成深夜书桌」就能切过去。",
        positionTip: "拖动光点决定灯从哪儿来；方向光和冷暖色的角度会跟着一起走。",
        directionalTip: "受光侧提亮、背光侧压暗。角度就是上面灯位指的方向。",
        rimTip: "沿立绘轮廓描一圈受光边。水平偏移的正负决定亮边在左还是在右。",
        filtersTip: "整幅画面的明暗与颜色，不开任何光源也能单独调。",
        angle: "入射角",
        blend: "混合模式",
        target: "作用目标",
        previewTitle: "实时预览",
        previewHint: "预览用的是当前场景的背景与立绘；画面里的真实灯光也会同步变化。",
        previewNoBg: "当前场景没有背景图，预览用的是示意底色。",
        builtinForkTip: "内置灯光不能直接改，这里是它的副本；保存后会出现在「我的预设」里。",
        forkName: "{name}（副本）",
        reset: "全部重置为无光",
        revert: "重置为原来效果",
        cancel: "取消",
