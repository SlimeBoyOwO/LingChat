export default {
  ...
  identity: {
    ...
    fieldName: "名字",
    fieldSubtitle: "副标题",
    fieldPrompt: "身份提示词（会注入聊天，描述「我」的身份设定）",
    fieldRelations: "关系",
    relationsHint:
      "可以填写「我和某个角色 / 我的其他身份」的关系。留空时会退一步，用对方卡上的信息作为「你已知的情报」，而不是当成既定关系。",
    targetAi: "AI 角色",
    targetMe: "我的身份",
    relationCount: "{n} 条关系",
    msg: {
      ...
      savedTitle: "身份已保存",
      savedMsg: "身份卡已更新",
      saveFailTitle: "保存身份失败",
      deleteConfirm: "确定删除身份「{name}」吗？有存档正在使用它时无法删除。",
      deleteFailTitle: "删除身份失败",
    },
  },
  history: {
    title: "历史对话",
  ...
  characterInfo: {
    ...
    relations: {
      title: "关系",
      hint: "这里填的是这个角色对各方的说法（例如「青梅竹马」「宿敌」）。它保存在角色目录的 relations.yml 中，覆盖角色设置时不会丢失。",
      save: "保存关系",
      missing: "目标已不存在（{key}）",
      msg: {
        savedTitle: "关系已保存",
        savedMsg: "这个角色的关系已更新",
        saveFailTitle: "保存关系失败",
        loadFailTitle: "读取关系失败",
      },
    },
    fields: {
      aiName: "AI 名称",
      aiSubtitle: "AI 副标题",
      userName: "该角色对「我」的称呼",
      userNameHint: "留空时用身份卡的名字（设置 → 角色 → 我的身份）",
      userSubtitle: "该角色对「我」的副标题",
      userSubtitleHint: "留空时用身份卡的副标题",
      title: "角色标题",
      info: "角色介绍",
      systemPrompt: "系统提示词",
  ...
  background: {
    scene: {
      ...
      categoryCreatedMsg: "分类「{name}」已创建",
      categoryCreateFail: "创建分类失败",
      categoryDeleted: "分类已删除",
      categoryDeletedMoved: "已删除分类「{name}」，并把 {count} 个背景移动到根目录",
      categoryDeleteFail: "删除分类失败",
      categoryDelete: "删除分类",
      categoryDeleteConfirmMove: "确定要删除分类「{name}」，并把其下背景全部移到主分类吗？",
      refresh: "刷新场景",
      refreshTip: "重新扫描背景文件夹，同步最新场景（含子文件夹）",
      refreshDone: "刷新完成",
  ...
  sound: {
    ...
    bgm: {
      ...
      categoryAdd: "新建分类",
      categoryDelete: "删除分类",
      categoryDeleteConfirmMove: "确定要删除分类「{name}」，并把其下音乐全部移到主分类吗？",
      refresh: "刷新音乐",
      openFolder: "打开文件夹",
      fav: "收藏（移到最前）",
      unfav: "取消收藏",
