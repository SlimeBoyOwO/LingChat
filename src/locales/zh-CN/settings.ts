export default {
  ...
  llmProviders: {
    ...
    form: {
      ...
      providerWorkbuddy: "WorkBuddy（腾讯 CodeBuddy 订阅）",
      apiKey: "API 密钥",
      baseUrl: "API 地址",
    ...
    workbuddy: {
      account: "WorkBuddy 订阅账号",
      loggedIn: "已登录",
      notLoggedIn: "未登录",
      realm: "区域",
      realmCn: "国内版（CodeBuddy）",
      realmGlobal: "国际版（WorkBuddy）",
      openUrlHint: "浏览器已打开授权页，若未自动打开可点击下方链接完成登录：",
      waitingAuth: "等待授权中…请在浏览器里完成登录",
      loginSuccess: "登录成功！",
      loginFailed: "登录失败: {error}",
      loginCn: "登录国内版（CodeBuddy）",
      loginGlobal: "登录国际版（WorkBuddy）",
      cancel: "取消登录",
      logout: "退出登录",
      quota: "查询额度",
      quotaRemaining: "剩余额度：{remaining} / {total} credits",
      riskHint: "使用个人订阅额度驱动对话可能违反服务条款，请自行评估风险",
    },
  },
