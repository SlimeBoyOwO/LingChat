export default {
  ...
  menu: {
    ...
    ttsTitle: "TTS 設定",
    ttsDesc:
      "DeBERTa とキャラクター音声モデルをダウンロード・管理して、オフラインでローカル TTS エンジンを使用。クラウド音声クローン（CosyVoice）で専用の音声を作成することも可能",
    ttsButton: "TTS 設定画面へ",
    asrTitle: "音声認識",
    ...
    affectionDesc:
      "好感度ハートの鼓動と赤い液体の波アニメーションの切替。鼓動オフ時はトップバーのハートのみ静止し、好感度パネル内は鼓動を継続します",
