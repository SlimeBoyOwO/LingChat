export default {
  ...
  llmProviders: {
    ...
    form: {
      ...
      providerWorkbuddy: "WorkBuddy（Tencent CodeBuddy サブスク）",
      apiKey: "API キー",
      baseUrl: "API URL",
    ...
    workbuddy: {
      account: "WorkBuddy サブスクリプションアカウント",
      loggedIn: "ログイン済み",
      notLoggedIn: "未ログイン",
      realm: "リージョン",
      realmCn: "中国版（CodeBuddy）",
      realmGlobal: "国際版（WorkBuddy）",
      openUrlHint:
        "ブラウザで認証ページを開きました。開かない場合は下のリンクからログインしてください：",
      waitingAuth: "認証待ち…ブラウザでログインを完了してください",
      loginSuccess: "ログインしました！",
      loginFailed: "ログインに失敗しました: {error}",
      loginCn: "ログイン（中国版 / CodeBuddy）",
      loginGlobal: "ログイン（国際版 / WorkBuddy）",
      cancel: "キャンセル",
      logout: "ログアウト",
      quota: "クォータを確認",
      quotaRemaining: "残りクォータ：{remaining} / {total} credits",
      riskHint:
        "個人サブスクリプションでの利用は利用規約に違反する可能性があります。リスクは自己判断で",
    },
  },
