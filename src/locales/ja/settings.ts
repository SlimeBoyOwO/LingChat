export default {
  ...
  sherpa: {
    title: 'Sherpa-ONNX ボイス',
    models: 'モデル一覧',
    noModels: '利用可能な Sherpa-ONNX モデルがありません',
    ...
    zeroShotDesc: '参照音声をアップロードすると、その声色を模倣して合成します',
    refLoaded: '参照音声を読み込みました',
    refNone: '音声が選択されていません',
    refChange: '変更',
    refPick: '音声を選択',
    refClear: 'クリア',
    refText: '参照テキスト（任意）',
    refTextPlaceholder: '参照音声の内容を入力するとクローン精度が向上します',
    test: '試聴テスト',
    testPlaceholder: 'テストテキストを入力',
    synthesizing: '合成中...',
    listen: '試聴',
    noModelHint: '先にモデルを選択してください',
  },
  log: {
    title: 'ログ',
    resume: '再開',
  ...
  characterInfo: {
    ...
    fields: {
      ...
      // Sherpa-ONNX 設定
      sherpaOnnxTitle: 'Sherpa-ONNX 音声設定',
      sherpaOnnxModelName: 'モデル名',
      sherpaOnnxModelPath: 'モデルパス',
      sherpaOnnxModelType: 'モデルタイプ',
      sherpaOnnxLanguage: '言語',
      sherpaOnnxVoice: '音色',
      sherpaOnnxUseGpu: 'GPU アクセラレーションを使用',
      sherpaOnnxParameters: 'モデルパラメータ',
      sherpaOnnxSpeed: '速度',
      sherpaOnnxPitch: 'ピッチ',
      sherpaOnnxRefAudio: '参照音声 (ゼロショットクローン)',
      sherpaOnnxRefText: '参照テキスト (任意)',
      sherpaOnnxRefTextPlaceholder: '参照音声に対応するテキストを入力するとクローン精度が向上します',
      noSherpaModel: 'Sherpa-ONNX モデルがインストールされていません（先に Sherpa 設定でダウンロード）',
      notInstalled: '未インストール',
      pickFile: '音声を選択',
      clearFile: 'クリア',
      sherpaOnnxManageModels: 'モデルを管理',
      sherpaOnnxVoices: {
        female: '女性',
        male: '男性',
        child: '子供',
