export default {
  ...
  plugins: {
    ...
    items: {
      lighting_studio: {
        name: "ライティング工房",
        description:
          "今の雰囲気を一言で伝えると、立ち絵と背景に自動で光を当てます（暖かい窓辺の光 / 冷たい月夜 / 逆光のシルエットなど）",
      },
    },
  },
  adventurePanel: {
  ...
  background: {
    ...
    lighting: {
      ...
      lowPerf: "低スペックモード",
      lowPerfHint: "ブリージングなどの継続アニメーションだけ停止し、静止した照明は維持します",
      presets: {
        warm_window: {
          name: "暖かい窓辺の光",
          description:
            "午後の日差しが窓から斜めに差し込む。ハイライトは琥珀色、影は青緑で eden の室内演出に近い",
        },
        backlight_silhouette: {
          name: "逆光のシルエット",
          description: "強い逆光で人物を暗く落とし輪郭が白く飛ぶ。登場や告白の場面に最適",
        },
        moonlit_night: {
          name: "冷たい月夜",
          description: "月光の青白さ、暗部を黒く締め、軽い bloom。夜の本音トーク向き",
        },
        dusk_sunset: {
          name: "黄昏",
          description: "低い角度の橙から紫のグラデーション空。暖冷の境目がはっきり",
        },
        candlelight: {
          name: "ろうそくの灯り",
          description: "小さな暖色光源＋速い明滅。停電・縁日・夜更けの向かい合いに",
        },
        neon_night: {
          name: "ネオンの夜",
          description: "ピンクと青のネオンのぶつかり合い、強めの bloom、色彩分離",
        },
        morning_soft: {
          name: "朝のやわらかい光",
          description: "明るくコントラストの低い朝の光。新しい一日の始まりに",
        },
        overcast_gray: {
          name: "曇りのフラット光",
          description: "彩度を落とし方向性もほぼない。気が沈む場面の余白",
        },
        rainy_gloom: {
          name: "雨のけむり",
          description: "冷たい灰青を暗めに、広い柔らかい光。Rain エフェクトと併用",
        },
        snow_bright: {
          name: "雪明かりの强光",
          description: "明るい寒色の白＋強い bloom。Snow エフェクトと併用",
        },
        forest_dapple: {
          name: "木漏れ日",
          description: "葉に濾された黄緑の木漏れ日。呼吸の振幅はやや大きめ",
        },
        classroom_noon: {
          name: "真昼の教室",
          description: "明るく中立、やや暖色。最も安全な日常の基盤光",
        },
        stage_spotlight: {
          name: "舞台のスポット",
          description: "狭いトップライト＋強いビネット。背景はほぼ全面暗い",
        },
        screen_glow: {
          name: "画面の冷光",
          description: "下から上へ青白い光＋速い呼吸。深夜のパソコンの前",
        },
        thriller_red: {
          name: "危険な赤光",
          description: "片側の血の赤＋心拍のような明滅。対立と危機",
        },
        dream_pastel: {
          name: "夢見るパステル",
          description: "ピンク紫、ローコントラスト＋bloom。回忆と夢",
        },
        golden_hour: {
          name: "ゴールデンアワー",
          description: "極端に低い角度の濃い橙の側光。輪郭光が最も強い",
        },
        night_ambient: {
          name: "夜の室内",
          description: "極端に暗い部屋＋かすかな寒色光源。深夜の部屋の常态",
        },
        sepia_memory: {
          name: "古い写真",
          description: "セピアで彩度を落とし強いビネット。回想や古い写真の場面",
        },
      },
      moodTags: {
        afternoon: "午後",
      ...
      select: {
        searchPlaceholder: "名前・説明・心情キーワードで検索",
        empty: "一致するプリセットはありません",
        newPreset: "＋ マイプリセットを作成",
        customGroup: "マイプリセット",
        builtinGroup: "内蔵プリセット",
        noneDefault: "デフォルトの灯りを使わない",
      },
      custom: {
        badge: "マイ",
        edit: "編集",
        delete: "削除",
        savedOk: "「マイプリセット」に保存し、デフォルトの灯りに設定しました：{name}",
        deleteConfirm: "ライティングプリセット「{name}」を削除しますか？この操作は取り消せません。",
        deleteFailed: "削除に失敗しました：{msg}",
      },
      editor: {
        titleNew: "ライティングを作成",
        titleEdit: "ライティングを編集",
        namePlaceholder: "この光に名前を付けて（最大24文字）",
        descriptionPlaceholder: "どんな雰囲気か一言（任意）",
        moodPlaceholder: "使える気分、スペース区切り。例：静寂 憧れ 夜",
        moodHint:
          "名前と気分キーワードでアシスタントがこの光を覚え、「真夜中の机に変えて」というだけで切り替えられます。",
        positionTip:
          "光る点をドラッグして光源の位置を決めると、方向光と冷暖色の角度もついていきます。",
        directionalTip: "受光側を明るく、背光側を暗くします。角度は上の光源位置のままです。",
        rimTip: "立ち絵の輪郭に光の縁をまとう。水平オフセットの符号で亮辺が左か右かが決まります。",
        filtersTip: "画面全体の明暗と色。光源を何もつけなくても単体で調整できます。",
        angle: "入射角",
        blend: "ブレンドモード",
        target: "適用先",
        ...
        save: "保存して適用",
        saving: "保存中…",
        nameRequired: "まずこのライティングに名前を付けてください",
        saveFailed: "保存に失敗しました：{msg}",
        section: {
          position: "光源位置",
          overlay: "ライトオーバーレイ（光斑）",
          directional: "方向光",
          rim: "リムライト",
          bloom: "ブルーム（ハイライトの広がり）",
          vignette: "ビネット（四周減光）",
          grade: "冷暖分離",
          breathing: "ブリージング",
          filters: "全体色付け",
        ...
        row: {
          ...
          overlayOpacity: "光照強度",
          lightStrength: "明暗強度",
          lightSoftness: "グラデーションの滑らかさ",
          rimDx: "水平オフセット",
          rimDy: "垂直オフセット",
          rimBlur: "縁のぼかし",
          bloomRadius: "ブルーム半径",
          bloomIntensity: "ブルーム強度",
