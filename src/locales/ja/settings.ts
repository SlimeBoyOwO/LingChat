export default {
  ...
  background: {
    ...
    lighting: {
      ...
      directional: "方向光（受光側は暖色、陰側は寒色）",
      rim: "リムライト（立ち絵の輪郭の光）",
      bloom: "ブルーム（ハイライトのにじみ）",
      vignette: "ビネット（四隅を暗くする）",
      grade: "ウォーム／コールド分離カラー",
      breathing: "ブリージング（明るさがゆっくり揺れる）",
      lowPerf: "低スペックモード",
      ...
      custom: {
        ...
        delete: "削除",
        newPreset: "＋ ライティングを作成",
        newPresetDesc: "自分で光を調整して「マイプリセット」に保存し、常時適用できます",
        savedOk: "「マイプリセット」に保存し、全体ライティングに設定しました：{name}",
