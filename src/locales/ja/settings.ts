export default {
  ...
  data: {
    export: {
      title: "データをエクスポート",
      hint: "バックアップする内容を選択して、単一の zip ファイルとしてローカルに保存します",
      button: "バックアップをエクスポート",
    },
    import: {
      title: "データをインポート",
      hint: "バックアップファイルを選択し、復元する内容を選んでインポートします",
      pickFile: "バックアップファイルを選択",
      button: "バックアップをインポート",
      selectItems: "復元する内容を選択",
      appVersion: "アプリバージョン",
      exportedAt: "エクスポート日時",
    },
    items: {
    ...
    importing: "インポート中...",
    importSuccess: "バックアップのインポートに成功しました",
    importFailed: "インポート失敗：{error}",
    restartHint: "データベースまたは設定が変更されました。アプリを再起動しますか？",
  },
};
