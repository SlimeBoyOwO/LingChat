export default {
  ...
  workshop: {
    ...
    installedEmpty: 'インストール済みのコンテンツなし',
    searchPlaceholder: 'パッケージ名・作者・説明を検索',
    detailCategory: 'カテゴリ',
    detailTags: 'タグ',
    detailTools: 'ツール',
    detailSize: 'サイズ',
    detailSha256: 'SHA-256 チェックサム',
    detailReview: '審査レポート',
    detailOpen: '開く',
    detailClose: '閉じる',
    installed: 'インストール済み',
  ...
  plugins: {
    ...
    networkHint: 'ネットワーク許可リスト（このホストのみアクセス可能）：',
    declaredToolsHint: 'call_tool 宣言（呼び出し可能な書き込みツール）：',
    saveConfig: '保存',
