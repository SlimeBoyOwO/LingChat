...
export default {
  ...
  background: {
    ...
    lighting: {
      ...
      sourceTool: "外掛程式或助手",
      sourcePanel: "設定面板",
      overriddenHint: "燈光正由「{who}」臨時控制；撳下面任何一個預設會即刻取消佢並接管",
      clearRuntime: "取消臨時燈光",
      clearRuntimeFailed: "取消臨時燈光失敗",
      takenOver: "已接管燈光：臨時燈光已經取消，而家按你揀嘅預設打光",
      switchesTitle: "分項開關",
      switchesHint: "只會熄咗對應效果，唔會改動場景或預設自帶嘅強度",
      overlay: "光照疊加層（整體染色）",
      directional: "方向光（受光面偏暖、背光面偏冷）",
      rim: "輪廓光（立繪邊緣亮光）",
      bloom: "泛光（高光溢出）",
      vignette: "暗角（四周壓暗）",
      grade: "冷熱分離調色",
      breathing: "呼吸動畫（亮度慢慢起伏）",
      lowPerf: "低效能模式",
      ...
      custom: {
        ...
        delete: "刪除",
        newPreset: "＋ 自訂光影",
        newPresetDesc: "自己調一盞燈，存進「我的預設」長期套用",
        savedOk: "已存進「我的預設」，並設為全域燈光：{name}",
