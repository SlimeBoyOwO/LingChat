...
export default {
  ...
  advanceOther: {
    ...
    embeddingStatus: {
      ...
      loading: "載入緊…",
      refresh: "更新狀態",
      organizeConversation: "一鍵整理當前對話",
      organizeResult:
        "整理完成：新增 {added} 條，跳過重複 {duplicates} 條，當前存檔已歸檔 {stored} 條。",
    ...
    fields: {
      ...
      embedding: {
        ...
        model_dir:
          "嵌入模型目錄（留空預設 data/third_party/embedding/，打包版會退回資源目錄內置模型，相對路徑會按數據目錄解析）",
  ...
  characterInfo: {
    ...
    fields: {
      ...
      sherpaOnnx: "Sherpa-ONNX 本地語音",
      sherpaOnnxModelName: "Sherpa-ONNX 模型",
      sherpaOnnxModelType: "模型類型",
      sherpaOnnxLanguage: "語言",
      sherpaOnnxVoice: "音色",
      sherpaOnnxUseGpu: "GPU 推理",
      sherpaOnnxSpeed: "語速",
      sherpaOnnxParameters: "參數",
      sherpaOnnxManageModels: "管理模型",
      sherpaOnnxVoicesMale: "男聲",
      sherpaOnnxVoicesFemale: "女聲",
      sherpaOnnxVoicesChild: "童聲",
      sherpaOnnxVoicesElderly: "老年聲",
      sherpaOnnxModelDir: "模型存放目錄",
      sherpaOnnxStoragePermHint:
        "模型存放於應用資料目錄（data/sherpa_onnx_models），無需額外儲存權限",
      sherpaOnnxGrantPermission: "立即授權",
      basicSettings: "基礎語音設定",
      emotion: "情感",
      emotionsNormal: "普通",
      emotionsHappy: "開心",
      emotionsSad: "難過",
      emotionsAngry: "嬲",
      emotionsSurprised: "驚訝",
      noSherpaModel: "未安裝 Sherpa-ONNX 模型（請先喺 TTS 設定度下載）",
    },
    placeholders: {
    ...
    delete: {
      ...
      pluginFromPlugin: "該角色來自插件，無法直接刪除。請喺「設定 · 插件」嘅資源區將佢隱藏。",
    },
    messages: {
  ...
  sherpa: {
    title: "Sherpa-ONNX 本地語音",
    models: "模型",
    noModels: "暫無可用模型，請先下載",
    manageModels: "打開模型資料夾",
    modelConfig: "模型配置",
    modelType: "模型類型",
    language: "語言",
    voice: "音色",
    ...
    speed: "語速",
    zeroShot: "零樣本聲音克隆",
    zeroShotDesc: "部分模型（如 kokoro/kitten 等）支援參考音訊 + 參考文字的零樣本克隆。",
    refLoaded: "參考音訊已載入",
    refNone: "未選擇參考音訊",
    refChange: "更換音訊",
    refPick: "選擇音訊",
    refClear: "清除",
    refText: "參考文字",
    refTextPlaceholder: "與參考音訊對應嘅文字……",
    test: "試聽",
    testPlaceholder: "輸入要試聽嘅文字……",
    synthesizing: "合成中…",
    listen: "試聽",
    noModelHint: "請先選擇一個已安裝嘅模型",
  },
