...
export default {
  ...
  "text": {
    ...
    "contextUsage": {
      ...
      "statusLine": "共 {lines} 條對話 · 口徑：{source} · 壓縮：{compacted}",
      "sourceMeasured": "API 實測+估算",
      "sourceEstimated": "純本地估算",
      "compactedYes": "已壓縮前 {upto} 條",
      "compactedNo": "未壓縮",
      "autoCompactDesc": "用量達到 85% 時自動壓縮（總結舊對話，保留最近 20 條原文）",
      "compactNow": "立即壓縮",
      "refresh": "刷新",
      "compactDone": "壓縮完成",
      "compactFailed": "壓縮失敗"
  ...
  "llmProviders": {
    ...
    "form": {
      ...
      "contextWindowHint": "留空按 128k 估算；用於通用頁的上下文用量顯示與自動壓縮。",
      "contextWindowDiscovered": "此模型申報窗口：{n}",
      "contextWindowAuto": "自動獲取",
      "contextWindowAutoDiscovered": "儲存時將使用模型申報窗口：{n}",
      "contextWindowAutoUnavailable": "未能取得此模型的申報窗口，儲存時將按 128k 估算",
