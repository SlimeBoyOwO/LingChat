...
export default {
  ...
  identity: {
    ...
    fieldName: "名",
    fieldSubtitle: "副標題",
    fieldPrompt: "身份提示詞（會注入聊天，描述「我」嘅身份設定）",
    fieldRelations: "關係",
    relationsHint:
      "可以填「我同某個角色 / 我其他身份」嘅關係。留空就會退一步，用對方卡上嘅資料做「你已知嘅情報」，而唔係當成既定關係。",
    targetAi: "AI 角色",
    targetMe: "我嘅身份",
    relationCount: "{n} 條關係",
    msg: {
      ...
      savedTitle: "身份已儲存",
      savedMsg: "身份卡已更新",
      saveFailTitle: "儲存身份失敗",
      deleteConfirm: "確定刪除身份「{name}」？有存檔用緊佢嘅話刪唔到。",
      deleteFailTitle: "刪除身份失敗",
    },
  },
  history: {
    title: "歷史對話",
  ...
  characterInfo: {
    ...
    relations: {
      title: "關係",
      hint: "呢度填嘅係呢個角色對各方嘅講法（例如「青梅竹馬」「宿敵」）。會存喺角色目錄嘅 relations.yml，覆蓋角色設定都唔會唔見。",
      save: "儲存關係",
      missing: "目標已經唔存在（{key}）",
      msg: {
        savedTitle: "關係已儲存",
        savedMsg: "呢個角色嘅關係已更新",
        saveFailTitle: "儲存關係失敗",
        loadFailTitle: "讀取關係失敗",
      },
    },
    fields: {
      aiName: "AI 名稱",
      aiSubtitle: "AI 副標題",
      userName: "呢個角色點稱呼「我」",
      userNameHint: "留空就用身份卡嘅名（設定 → 角色 → 我嘅身份）",
      userSubtitle: "呢個角色對「我」嘅副標題",
      userSubtitleHint: "留空就用身份卡嘅副標題",
      title: "角色標題",
      info: "角色介紹",
      systemPrompt: "系統提示詞",
  ...
  background: {
    scene: {
      ...
      categoryCreatedMsg: "分類「{name}」已創建",
      categoryCreateFail: "創建分類失敗",
      categoryDeleted: "分類已刪除",
      categoryDeletedMoved: "已刪除分類「{name}」，並將 {count} 個背景移到根目錄",
      categoryDeleteFail: "刪除分類失敗",
      categoryDelete: "刪除分類",
      categoryDeleteConfirmMove: "確定要刪除分類「{name}」，並將佢下面嘅背景全部移到主分類咩？",
      refresh: "刷新場景",
  ...
  sound: {
    ...
    bgm: {
      ...
      categoryAdd: "新建分類",
      categoryDelete: "刪除分類",
      categoryDeleteConfirmMove: "確定要刪除分類「{name}」，並將佢下面嘅音樂全部移到主分類咩？",
      refresh: "刷新音樂",
      openFolder: "開文件夾",
      fav: "收藏（移到最前）",
      unfav: "取消收藏",
