...
export default {
  ...
  llmProviders: {
    ...
    form: {
      ...
      providerWorkbuddy: "WorkBuddy（騰訊 CodeBuddy 訂閱）",
      apiKey: "API 密鑰",
      baseUrl: "API 地址",
    ...
    workbuddy: {
      account: "WorkBuddy 訂閱帳號",
      loggedIn: "已登入",
      notLoggedIn: "未登入",
      realm: "區域",
      realmCn: "國內版（CodeBuddy）",
      realmGlobal: "國際版（WorkBuddy）",
      openUrlHint: "瀏覽器已經打開授權頁，若冇自動打開可以撳下面條連結完成登入：",
      waitingAuth: "等緊授權…請喺瀏覽器完成登入",
      loginSuccess: "登入成功！",
      loginFailed: "登入失敗: {error}",
      loginCn: "登入國內版（CodeBuddy）",
      loginGlobal: "登入國際版（WorkBuddy）",
      cancel: "取消登入",
      logout: "登出",
      quota: "查詢額度",
      quotaRemaining: "剩餘額度：{remaining} / {total} credits",
      riskHint: "用個人訂閱額度嚟傾偈可能違反服務條款，請自行評估風險",
    },
  },
  tts: {
    title: "TTS 設置",
