...
export default {
  ...
  "workshop": {
    ...
    "discussionsTab": "創意工坊",
    "marketTab": "市場",
    "marketHint": "AI 全自動審核嘅市場：安裝即信任審核結果",
    "marketEmpty": "市場暫時冇可安裝嘅包",
    "marketNoMatch": "冇搵到符合嘅包",
    "searchPlaceholder": "搜尋包名 / 作者 / 描述",
    "detailCategory": "分類",
    "detailTags": "標籤",
    "detailTools": "工具",
    "detailSize": "大小",
    "detailSha256": "SHA-256 校驗值",
    "detailReview": "審核報告",
    "detailOpen": "查看",
    "detailClose": "關閉",
    "installed": "已安裝",
  ...
  "plugins": {
    ...
    "networkHint": "網絡白名單（僅允許訪問以下地址）：",
    "declaredToolsHint": "call_tool 聲明（可調用嘅寫工具）：",
    "saveConfig": "儲存",
