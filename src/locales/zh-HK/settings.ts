...
export default {
  ...
  advanceOther: {
    ...
    affectionAnim: {
      title: "好感度動畫",
      desc: "好感度愛心嘅跳動同紅色液體波浪動畫開關，即時生效；閂咗心跳之後頂欄愛心靜止，好感度面板內仍會跳動",
      heartbeat: "啟用心跳動畫",
      wave: "啟用波浪動畫",
    },
    saveButton: "儲存",
  ...
  data: {
    export: {
      title: "匯出資料",
      hint: "勾選需要備份的內容，打包為單個 zip 檔案儲存到本機",
      button: "匯出備份",
    },
    import: {
      title: "匯入資料",
      hint: "選擇備份檔案，勾選需要恢復的內容後匯入",
      pickFile: "選擇備份檔案",
      button: "匯入備份",
      selectItems: "選擇要恢復的內容",
      appVersion: "應用版本",
      exportedAt: "匯出時間",
    },
    items: {
    ...
    importFailed: "匯入失敗：{error}",
    restartHint: "資料庫或設定已更改，是否重啟應用程式以生效？",
  },
};
