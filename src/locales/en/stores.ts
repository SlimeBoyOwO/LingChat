...
export default {
  ...
  llmErrors: {
    invalid_api_key:
      "Your API key is invalid! Please check it for typos or extra spaces, and whether it has expired or run out of quota.",
    ...
    timeout:
      "Request timed out: check network stability, provider load, or increase the idle timeout setting.",
    network_error:
      "Network connection failed: check your network, Base URL accessibility, or proxy.",
    empty_response:
      "The model returned an empty response: try a different model or adjust parameters.",
  ...
  updater: {
    networkError:
      "Network connection failed — can't reach the update server. Please check your network and try again.",
