...
export default {
  ...
  toolCalls: {
    ...
    commandDeleteApprovalTitle: "Confirm Dangerous Command",
    commandDeleteApprovalMessage: "This command was flagged as dangerous:\n\n{command}\n\nWorking directory: {cwd}\n\nReason: {risk}\n\nAllow it to run?",
    commandDeleteRiskFallback: "may delete files or modify system settings",
    ...
    commandAutoApproveHint: "⚠ Dangerous! Commands can run without consent; delete, elevation, and other dangerous commands still always require a confirmation popup",
    commandDeleteAutoApprove: "Run delete commands without confirmation (overridden by security policy)",
    commandDeleteAutoApproveHint: "⚠ The security policy overrides this switch: delete and other dangerous commands always require a confirmation popup regardless of this setting; it no longer takes effect",
  ...
  lanSync: {
    ...
    pull: "Pull",
    push: "Push",
    ownTokenLabel: "This device's pairing token",
    ownTokenCopy: "Copy",
    ownTokenCopied: "Copied",
    ownTokenHint: "Paste this token into the Pairing input on the other device to trust it.",
    paired: "Paired",
    pair: "Pair",
    unpair: "Unpair",
    pairConfirm: "Confirm pairing",
    pairTokenPlaceholder: "Enter the other device's pairing token",
    pairFailed: "Pairing failed (make sure the token comes from the target device)",
