...
export default {
  ...
  toolCalls: {
    ...
    imageGenTitle: "Scene Backgrounds",
    ...
    naiHeight: "Height",
    naiSteps: "Steps",
    freeTierOk: "{pixels} pixels — within the Opus free allowance, costs no Anlas",
    freeTierExceeded:
      "⚠ {pixels} pixels exceeds the free allowance ({maxPixels} pixels / {maxSteps} steps); generating will start costing Anlas",
    stylePrompt: "Style tags",
    stylePromptHint:
      "Prepended to every prompt to keep one consistent look. Defaults to excluding people — sprites are drawn over the background, so the background itself shouldn't contain any.",
    naiNegativePrompt: "Negative prompt (appended)",
    requireConfirm: "Ask me first (show a confirmation before they generate)",
    requireConfirmOffHint:
      "While off, they paint directly without interrupting the conversation (10–30 seconds per image; spending is still capped by the free-allowance limit below)",
    freeTierOnly: "Free allowance only (reject requests over the size/step limits)",
    freeTierOnlyOffHint: "⚠ Once off, oversized generations run anyway and consume Anlas",
    testConnection: "Test Connection",
    testConnectionSuccess: "Connected: {tier}, {anlas} Anlas remaining",
    testConnectionFailed: "Connection failed: {message}",
    sceneGenerateApprovalTitle: "Generate Scene Background",
    sceneGenerateApprovalMessage:
      "They want to paint a background for the new scene \"{name}\":\n\n{description}\n\nPrompt: {prompt}\n\n{size} / {steps} steps · {cost}\n\nThis takes 10–30 seconds. Continue?",
    sceneGenerateFreeTier: "within the free allowance, no Anlas",
    sceneGeneratePaid: "⚠ over the free allowance, will cost Anlas",
    ...
    groups: {
      ...
      scene: "Scene Switching (list/switch/return to scenes)",
    ...
    tools: {
      ...
      scene_generate: "Generate Scene Background",
      scene_return: "Return to Original Scene",
