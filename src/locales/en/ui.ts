...
export default {
  ...
  toolCalls: {
    ...
    groups: {
      ...
      lighting: "Stage Lighting (list/switch lighting presets)",
    ...
    tools: {
      ...
      lighting_list_presets: "List Lighting Presets",
      lighting_apply: "Switch Stage Lighting",
      lighting_get: "Current Stage Lighting",
      lighting_studio_list: "Lighting Studio · Preset List",
      lighting_studio_apply: "Lighting Studio · Light By Name",
      lighting_studio_mood: "Lighting Studio · Light By Mood",
