...
export default {
  ...
  sherpa: {
    title: "Sherpa-ONNX Voice",
    models: "Model List",
    noModels: "No Sherpa-ONNX models available",
    ...
    zeroShotDesc: "Upload a reference audio, the model will mimic its timbre",
    refLoaded: "Reference audio loaded",
    refNone: "No audio selected",
    refChange: "Change",
    refPick: "Select Audio",
    refClear: "Clear",
    refText: "Reference Text (optional)",
    refTextPlaceholder: "Enter the text spoken in the reference audio to improve cloning",
    test: "Preview Test",
    testPlaceholder: "Enter test text",
    synthesizing: "Synthesizing...",
    listen: "Listen",
    noModelHint: "Please select a model first",
  },
  log: {
    title: "Logs",
    resume: "Resume",
  ...
  characterInfo: {
    ...
    fields: {
      ...
      sherpaOnnxTitle: "Sherpa-ONNX Voice Settings",
      sherpaOnnxModelName: "Model Name",
      sherpaOnnxModelPath: "Model Path",
      sherpaOnnxModelType: "Model Type",
      sherpaOnnxLanguage: "Language",
      sherpaOnnxVoice: "Voice",
      sherpaOnnxUseGpu: "Use GPU Acceleration",
      sherpaOnnxParameters: "Model Parameters",
      sherpaOnnxSpeed: "Speed",
      sherpaOnnxPitch: "Pitch",
      sherpaOnnxRefAudio: "Reference Audio (Zero-shot Cloning)",
      sherpaOnnxRefText: "Reference Text (Optional)",
      sherpaOnnxRefTextPlaceholder: "Text corresponding to the reference audio to improve cloning",
      noSherpaModel: "No Sherpa-ONNX model installed (download one in Sherpa settings first)",
      notInstalled: "Not installed",
      pickFile: "Choose Audio",
      clearFile: "Clear",
