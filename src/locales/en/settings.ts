...
export default {
  ...
  workshop: {
    ...
    installedEmpty: "No installed content",
  ...
  plugins: {
    ...
    networkHint: "Network whitelist (only these hosts are reachable):",
    declaredToolsHint: "call_tool declarations (writable tools it may call):",
    saveConfig: "Save",
