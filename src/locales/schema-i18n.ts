...
const EVENT_KEYS: Record<string, string> = {
  ...
  set_player_identity: "event.setPlayerIdentity",
...
const FIELD_KEYS: Record<string, string> = {
  ...
  user_subtitle: "field.userSubtitle",
  user_prompt: "field.userPrompt",
  persona_id: "field.personaId",
  scope: "field.scope",
...
const PLACEHOLDER_KEYS: Record<string, string> = {
  ...
  user_subtitle: "placeholder.userSubtitle",
...
const OPTION_KEYS: Record<string, string[]> = {
  ...
  "set_player_identity.scope": [
    "option.scopeChapter",
    "option.scopeScript",
    "option.scopePermanent",
  ],
};
