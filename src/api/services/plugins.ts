...
import type { ArchiveFormat, ArchiveImportResult, PluginConflictPolicy } from "./archive";
...
export async function savePluginConfig(id: string, config: Record<string, unknown>): Promise<void> {
