...
export function initializeTauriEventListeners() {
  ...
  console.log(
    "[Tauri] Event listeners initialized (ai + ai:thinking_progress + tts:cleanup + adventure + auto-save + 16 script events + character:switch + scene:switch + lighting:change)",
  );
}
