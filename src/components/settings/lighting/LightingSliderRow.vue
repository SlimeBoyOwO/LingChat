<template>
  <div class="flex items-center gap-2">
    ...
    <input
      ...
      type="text"
      inputmode="decimal"
      class="w-14 shrink-0 rounded border border-transparent bg-transparent px-1 py-0.5 text-right text-[11px] text-white/60 tabular-nums transition-colors hover:border-white/15 hover:text-white/80 focus:border-amber-400/60 focus:bg-black/30 focus:text-white focus:outline-none disabled:opacity-40"
      :disabled="disabled"
      @focus="onFocus"
      @blur="commit"
