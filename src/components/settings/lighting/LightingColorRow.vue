<template>
  <div class="flex items-center gap-2" :class="{ 'opacity-40': disabled }">
    ...
    <input
      ...
      type="text"
      spellcheck="false"
      class="min-w-0 flex-1 rounded border border-transparent bg-transparent px-1 py-0.5 text-[11px] text-white/30 uppercase transition-colors hover:border-white/15 hover:text-white/60 focus:border-amber-400/60 focus:bg-black/30 focus:text-white focus:outline-none"
      :disabled="disabled"
      @focus="editing = true"
      @blur="commit"
