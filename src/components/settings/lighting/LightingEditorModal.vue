<template>
  <Teleport to="body">
    <Transition name="modal">
      <div
        v-if="show"
        class="fixed inset-0 z-9999 flex items-center justify-center bg-black/50 p-4 backdrop-blur-md"
        @click="close"
      >
        <div
          ...
          >
            ...
            <div class="flex-1 space-y-4 overflow-y-auto p-4">
              ...
              <div
                ...
                class="rounded-xl border border-amber-400/30 bg-amber-400/10 px-3 py-2 text-[11px] leading-snug text-amber-100/80"
              >
              ...
              <div class="space-y-2">
                <input
                  ...
                  maxlength="24"
                  class="w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2 text-sm text-white placeholder-white/30 focus:border-amber-400/60 focus:ring-1 focus:ring-amber-400/40 focus:outline-none"
                />
                <input
                  v-model="description"
                  :placeholder="$t('settings.background.lighting.editor.descriptionPlaceholder')"
                  maxlength="60"
                  class="w-full rounded-xl border border-white/10 bg-black/40 px-2.5 py-1.5 text-xs text-white placeholder-white/30 focus:border-amber-400/60 focus:outline-none"
                />
                <input
                  v-model="mood"
            ...
            <div
              class="flex shrink-0 items-center justify-between gap-2 border-t border-white/10 bg-white/5 p-3"
            >
              <button
                @click="revert"
                class="text-[11px] text-white/40 underline transition-colors hover:text-white/80"
              ...
              <div class="flex items-center gap-2">
                ...
                <Button
                  ...
                  class="min-w-[70px] border-none bg-amber-500! text-sm! text-white shadow-[0_0_10px_rgba(245,158,11,0.5)] hover:bg-amber-400! disabled:opacity-50 disabled:shadow-none"
                >
                  {{
                    saving
