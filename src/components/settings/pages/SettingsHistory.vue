    ...
    <MenuItem :title="$t('settings.history.title')">
      ...
      <div class="flex h-full max-h-[75dvh] min-h-0 flex-col">
        ...
        <div v-else class="flex min-h-0 flex-1 flex-col">
          <div
            ref="contentRef"
            class="min-h-0 flex-1 scrollbar-thin [scrollbar-color:var(--accent-color,#79d9ff)_transparent] overflow-y-auto scroll-smooth px-1.5 py-3.5"
              ...
              >
                ...
                <div v-if="item.thinking" class="mb-1">
                  ...
                  <div
                    ...
                    class="mt-1.5 max-h-64 scrollbar-thin overflow-y-auto rounded-2xl border border-[rgba(121,217,255,0.15)] bg-[rgba(121,217,255,0.05)] px-4 py-3 text-[15px] leading-normal whitespace-pre-wrap text-white/55"
                  >
                    {{ item.thinking }}
                  </div>
                </div>
          ...
          >
            <button
              class="cursor-pointer rounded-lg border-0 bg-[#e9ecef] px-4 py-1.5 text-sm font-medium text-[#495057] transition-all duration-200 hover:not-disabled:-translate-y-0.5 hover:not-disabled:bg-(--accent-color,#79d9ff) hover:not-disabled:text-white hover:not-disabled:shadow-[0_4px_10px_rgba(121,217,255,0.4)] disabled:cursor-not-allowed disabled:opacity-40"
