  ...
  <MenuPage>
    <MenuItem :title="$t('settings.save.create.title')">
      ...
      <div class="flex gap-2.5">
        ...
        />
        <button
          class="w-[10%] min-w-16.25 cursor-pointer rounded-md border border-[rgba(0,255,55,0.3)] bg-[rgba(0,255,55,0.2)] px-4 py-2 whitespace-nowrap text-[#ddd] transition-all duration-200 hover:-translate-y-px hover:bg-[rgba(0,255,55,0.35)] hover:shadow-[0_0_10px_rgba(0,255,55,0.15)]"
    ...
    <MenuItem :title="$t('settings.save.list.title')">
      ...
      <div class="flex flex-col">
        <div class="h-[calc(100dvh-22rem)] min-h-75 overflow-y-auto pr-1 pb-4">
          ...
          <div v-else class="grid grid-cols-1 gap-5 p-1.25 md:grid-cols-2">
            <div
              v-for="(save, index) in saves"
              :key="save.id"
              class="flex flex-col rounded-xl border border-white/10 bg-[rgba(20,20,20,0.45)] p-4 shadow-[0_8px_32px_rgba(0,0,0,0.2)] backdrop-blur-[10px] transition-all duration-300 ease-[cubic-bezier(0.25,0.8,0.25,1)] hover:-translate-y-0.75 hover:border-[rgba(121,217,255,0.35)] hover:bg-[rgba(20,20,20,0.55)] hover:shadow-[0_12px_40px_rgba(121,217,255,0.08)]"
            >
              <div class="flex gap-4">
                <!-- Left: Screenshot Preview -->
                <div
                  class="h-48 w-1/2 shrink-0 overflow-hidden rounded-lg border border-white/8 bg-black/40"
                >
                  <img
                  ...
                  <div
                    v-else
                    class="flex h-full w-full flex-col items-center justify-center bg-white/2"
                  >
                ...
                <div class="flex flex-1 flex-col justify-between overflow-hidden">
                  ...
                  <div class="mt-1.5 flex min-h-6.5 items-center">
                    <input
                      ...
                      class="w-full rounded border border-[rgba(121,217,255,0.5)] bg-black/50 px-1.5 py-0.5 text-sm font-bold text-white outline-none"
                    />
                    <div
                      v-else
                      @dblclick="startEditTitle(save)"
                      class="max-w-full cursor-pointer truncate text-sm font-bold text-white transition-colors duration-200 select-none hover:text-sky-300"
                  ...
                  <!-- Line 3: Last Message -->
                  <div
                    class="line-clamp-2 h-8.25 text-xs leading-[1.4] text-white/65 italic"
              ...
              <div class="mt-4 flex gap-2 border-t border-white/5 pt-3">
                <button
                  ...
                  class="flex-1 cursor-pointer rounded-md border border-blue-500/40 bg-blue-500/25 px-3 py-1.5 text-xs font-semibold whitespace-nowrap text-white transition-all duration-200 hover:bg-blue-500/45 hover:shadow-[0_0_10px_rgba(59,130,246,0.2)] disabled:cursor-not-allowed disabled:opacity-50"
                  :disabled="actionLoading !== null"
                >
                  {{
                ...
                <button
                  ...
                  class="flex-1 cursor-pointer rounded-md border border-emerald-500/40 bg-emerald-500/25 px-3 py-1.5 text-xs font-semibold whitespace-nowrap text-white transition-all duration-200 hover:bg-emerald-500/45 hover:shadow-[0_0_10px_rgba(16,185,129,0.2)] disabled:cursor-not-allowed disabled:opacity-50"
                  :disabled="actionLoading !== null"
                >
                  {{
                    actionLoading === save.id
                ...
                <button
                  ...
                  class="flex-1 cursor-pointer rounded-md border border-red-500/40 bg-red-500/25 px-3 py-1.5 text-xs font-semibold whitespace-nowrap text-white transition-all duration-200 hover:bg-red-500/45 hover:shadow-[0_0_10px_rgba(239,68,68,0.2)] disabled:cursor-not-allowed disabled:opacity-50"
                  :disabled="actionLoading !== null"
                >
                  {{
                    actionLoading === save.id
