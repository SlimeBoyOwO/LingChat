<template>
  <div class="flex items-center">
    ...
    >
      <span
        class="relative mr-2 inline-block h-6.5 w-12.5 shrink-0 rounded-[13px] transition-all duration-300 ease-in-out"
        :class="[
          internalChecked
      ...
      >
        <span
          class="absolute top-1/2 h-5 w-5 -translate-y-1/2 rounded-full transition-all duration-300 ease-in-out"
          :class="[
            internalChecked
