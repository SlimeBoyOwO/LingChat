...
<template>
  ...
  <Teleport to="#app">
    ...
    >
      ...
      >
        <div
          class="max-h-[86dvh] w-[min(460px,92vw)] overflow-y-auto rounded-xl border
        ...
        >
          ...
          <div
            ...
            :key="a"
            class="flex items-center gap-3 border-t border-white/[0.06] py-1.5 text-[0.78rem]
              leading-[1.8] text-white/70 [&:first-child]:border-t-0"
            :class="recording === a ? 'text-brand' : 'cursor-pointer hover:text-white'"
            @click="recording = a"
          >
            <kbd
              class="text-brand min-w-[148px] shrink-0 rounded-[5px] border border-white/[0.14]
                bg-white/5 px-2 py-0.5 font-mono text-[0.7rem]"
            >
              {{
                recording === a
          ...
          <div class="mt-4 flex justify-end">
            <button
              class="inline-flex items-center gap-1 rounded-lg border border-white/10 bg-white/6
                px-3 py-[0.3rem] text-[0.78rem] whitespace-nowrap text-white/70 transition-all
