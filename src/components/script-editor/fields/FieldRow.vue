  ...
  <div class="mb-4">
    ...
    <div v-else-if="field.kind === 'asset'">
      <div class="flex gap-2">
        ...
        <button
          class="shrink-0 rounded-lg border border-white/[0.1] bg-white/[0.06] px-[0.7rem]
            text-[0.78rem] whitespace-nowrap text-white/[0.7] transition-all hover:bg-white/[0.14]
            hover:text-white"
        ...
        <button
          class="shrink-0 rounded-lg border border-[rgba(167,139,250,0.3)]
            bg-[rgba(167,139,250,0.1)] px-[0.7rem] text-[0.78rem] whitespace-nowrap text-[#c4b5fd]
            transition-all hover:bg-[rgba(167,139,250,0.22)]"
