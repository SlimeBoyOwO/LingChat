<template>
  <div class="relative">
    ...
    <span
      v-if="conditionText"
      class="absolute -top-[7px] -left-[21px] rounded-[3px] border border-[rgba(251,191,36,0.32)] bg-[rgba(251,191,36,0.16)] px-[5px] font-mono text-[9px] whitespace-nowrap text-[#fcd34d]"
    ...
    >
      ...
      <span
        v-if="varBadge"
        class="max-w-[10rem] shrink-0 cursor-pointer truncate rounded border border-[rgba(34,211,238,0.35)] bg-[rgba(34,211,238,0.14)] px-[5px] py-px text-[0.62rem] leading-[1.6] whitespace-nowrap text-[#67e8f9] transition-all hover:bg-[rgba(34,211,238,0.25)]"
        :title="varBadge"
      ...
      <span
        v-if="errorCount"
        class="shrink-0 rounded border border-[rgba(248,113,113,0.35)] bg-[rgba(248,113,113,0.15)] px-[5px] py-px text-[0.62rem] leading-[1.6] whitespace-nowrap text-[#fca5a5]"
        >{{ t("scriptEditor.chapterFlow.errors", { count: errorCount }) }}</span
      >
      <span
        v-else-if="warnCount"
        class="shrink-0 rounded border border-[rgba(251,191,36,0.3)] bg-[rgba(251,191,36,0.15)] px-[5px] py-px text-[0.62rem] leading-[1.6] whitespace-nowrap text-[#fcd34d]"
