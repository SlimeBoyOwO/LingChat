  ...
  <div class="rail relative pl-[22px]">
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <div
            class="max-h-[80vh] w-[min(560px,92vw)] overflow-y-auto rounded-xl border border-white/12.5 bg-[rgba(12,20,30,0.86)] px-[18px] py-4 pb-[18px] shadow-[0_8px_32px_rgba(0,0,0,0.45),inset_0_1px_1px_rgba(255,255,255,0.06)] backdrop-blur-lg backdrop-saturate-[1.4]"
          >
