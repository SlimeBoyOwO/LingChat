      ...
      <div class="my-4 rounded-xl border border-white/10 bg-black/15 p-4">
        ...
        <template v-if="isAdventure">
          ...
          <div class="mb-4">
            ...
            <p
              class="mb-2 text-[0.72rem] leading-[1.7] text-white/40 [&_b]:font-semibold [&_b]:text-white/85"
            ...
            <button
              class="hover:border-brand hover:text-brand mt-1 rounded-lg border border-dashed border-white/15 px-3 py-1.5 text-xs text-white/45 transition-all"
              @click="addCondition"
            >
