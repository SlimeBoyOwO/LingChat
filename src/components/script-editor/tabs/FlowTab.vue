...
<template>
  ...
  <div v-else ref="editorWrap" class="mx-auto flex min-h-0 w-[94%] flex-1 gap-5 px-3 py-4">
    ...
    <div
      class="relative flex min-h-0 flex-col transition-[flex-basis] duration-300 ease-out"
