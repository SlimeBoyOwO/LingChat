  ...
  <Teleport to="body">
    <Transition name="modal">
      <div
        ...
        class="fixed inset-0 z-[10000] flex items-center justify-center bg-slate-900/60
          backdrop-blur-sm"
      >
        <div
          class="flex max-h-[80dvh] w-[520px] flex-col overflow-hidden rounded-3xl bg-slate-800/90
            shadow-2xl"
        >
          <!-- 头部 -->
          ...
          <div class="scrollbar-hide flex-1 overflow-y-auto px-6 pb-2">
            ...
            <template v-if="phase === 'review' && syncInfo">
              <!-- 统计栏 -->
              <div
                class="mb-3 flex items-center justify-between rounded-xl bg-slate-700/50 px-4 py-2
