<template>
  <div
    :class="[
      `relative flex h-full w-full flex-col overflow-hidden rounded-xl border font-sans
  ...
  >
    <div
      class="bg-grid-pattern pointer-events-none absolute inset-0 z-0 opacity-40 transition-colors
        duration-300"
      style="background-size: 24px 24px"
    ></div>

    <section
      class="relative z-10 m-1 flex h-full w-full flex-col overflow-hidden rounded-xl border
        shadow-2xl backdrop-blur-md transition-colors duration-300 md:m-2"
