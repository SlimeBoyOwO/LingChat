  ...
  <article class="flex h-full min-h-0 w-full flex-col">
    ...
    <div class="flex min-h-0 flex-1 flex-col gap-3">
      ...
      <div
        ...
        class="flex flex-1 flex-col items-center justify-center rounded-xl border-2 border-dashed p-8 transition-all"
        :class="
          isDarkMode
      ...
      <div v-else class="flex min-h-0 flex-1 flex-col gap-4">
        ...
        <div
          ref="contentRef"
          class="min-h-0 flex-1 overflow-y-auto scroll-smooth rounded-xl border p-4 shadow-sm transition-all"
            ...
            >
              ...
              <div v-if="item.thinking" class="mb-1">
                ...
                <div
                  ...
                  class="mt-1.5 max-h-64 scrollbar-thin overflow-y-auto rounded-2xl border px-4 py-3 text-[15px] leading-normal whitespace-pre-wrap"
                  :class="
                    isDarkMode
        ...
        <div v-if="totalPages > 1" class="flex shrink-0 items-center justify-between px-1">
          <button
            class="flex cursor-pointer items-center gap-1 rounded-lg border px-4 py-2 text-xs font-bold transition-all disabled:cursor-not-allowed disabled:opacity-40"
            :class="
              isDarkMode
                ? `border-slate-700 bg-slate-800/50 text-slate-300 hover:border-slate-600 hover:bg-slate-700 hover:text-sky-400`
                : `border-slate-200 bg-white text-slate-600 hover:border-sky-200 hover:bg-sky-50 hover:text-sky-500`
            "
