            ...
            >
              <div class="model-info">
                ...
                <span class="model-meta">
                  {{ model.model_type.toUpperCase() }} · {{ model.language }} · {{ formatSize(model.size_bytes) }}
                </span>
              </div>
        ...
        <section class="config-section">
          ...
          <div class="config-grid">
            <div class="config-item">
              <label class="config-label">{{ $t('settings.characterInfo.fields.sherpaOnnxModelType') }}</label>
            ...
            <div class="config-item">
              <label class="config-label">{{ $t('settings.characterInfo.fields.sherpaOnnxLanguage') }}</label>
            ...
            <div class="config-item">
              <label class="config-label">{{ $t('settings.characterInfo.fields.sherpaOnnxVoice') }}</label>
            ...
            <div class="config-item">
              <label class="config-label">{{ $t('settings.characterInfo.fields.sherpaOnnxUseGpu') }}</label>
              <label class="toggle-wrapper">
                <input v-model="settings.sherpa_onnx_use_gpu" type="checkbox" class="toggle-input" />
          ...
          <div class="param-grid">
            <div class="param-item">
              <div class="param-header">
                <label class="param-label">{{ $t('settings.characterInfo.fields.sherpaOnnxSpeed') }}</label>
            ...
            <div class="param-item">
              <div class="param-header">
                <label class="param-label">{{ $t('settings.characterInfo.fields.sherpaOnnxPitch') }}</label>
          ...
          <div class="ref-audio-card" :class="{ active: settings.sherpa_onnx_ref_audio_path }">
            <div class="ref-audio-info">
              ...
              <div v-else class="ref-audio-detail">
                ...
                <span class="ref-audio-status">支持 WAV / MP3 / OGG / FLAC</span>
              </div>
            </div>
            <div class="ref-audio-actions">
              <button @click="pickRefAudio" class="btn-secondary">
                <FolderOpen :size="16" /> {{ settings.sherpa_onnx_ref_audio_path ? '更换' : '选择音频' }}
              </button>
              <button
...
import {
  X, Cpu, Package, Settings, SlidersHorizontal, Wand2, Mic, Play, Check,
  FolderOpen, Download, Trash2, Loader2, MicVocal,
