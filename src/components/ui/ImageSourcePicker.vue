    ...
    <Transition name="picker-fade">
      ...
      >
        ...
        <div
          ...
          class="relative mx-3 mb-6 w-full max-w-md overflow-hidden rounded-2xl border
            border-white/10 bg-neutral-900/95 shadow-2xl"
        >
          ...
          <button
            type="button"
            class="flex w-full items-center gap-3 px-5 py-4 text-left text-white transition-colors
          ...
          <button
            type="button"
            class="flex w-full items-center gap-3 border-t border-white/5 px-5 py-4 text-left
              text-white transition-colors hover:bg-white/10 active:bg-white/15"
            @click="onGallery"
          >
          ...
          <button
            type="button"
            class="w-full border-t border-white/10 px-5 py-3 text-sm text-white/70 transition-colors
              hover:bg-white/10 active:bg-white/15"
            @click="onCancel"
          >
