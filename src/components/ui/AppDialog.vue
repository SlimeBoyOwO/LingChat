    ...
    <Transition name="modal">
      <div>
        ...
        >
          <!-- Dialog card -->
          <div
            class="relative z-10 w-full max-w-md overflow-hidden rounded-xl border border-white/20 bg-slate-900 p-8"
            @click.stop
          >
            <div
              class="text-brand absolute top-4 right-4 flex h-10 w-10 -rotate-18 transform items-center justify-center rounded-full shadow-md"
            >
              <PawPrint :size="30" />
            </div>
            ...
            <div class="mt-6 flex justify-end gap-2.5 border-t border-slate-800/80 pt-4">
              <button
                ...
                ref="cancelBtn"
                class="rounded-xl border border-white/20 bg-transparent px-6 py-1.5 text-sm font-bold text-white/70 transition-all hover:bg-white/10 hover:text-white"
              >
              ...
              <button
                ...
                ref="okBtn"
                class="rounded-xl bg-cyan-500 px-6 py-1.5 text-sm font-bold text-white shadow-lg shadow-cyan-500/25 transition-all hover:bg-cyan-400 active:scale-100"
              >
                {{ $t("ui.appDialog.ok") }}
              </button>
            </div>
