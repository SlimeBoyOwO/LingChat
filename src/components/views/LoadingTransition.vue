<template>
  ...
  <div class="loading-transition-root">
    ...
    >
      ...
      <!-- 扫描线效果 -->
      <div class="scanline pointer-events-none absolute inset-0"></div>
      ...
      <div
        ...
        :key="p.id"
        class="glow-cyan animate-particle pointer-events-none absolute rounded-full bg-cyan-400/50"
        :style="{
          left: p.left + '%',
          width: p.size + 'px',
          height: p.size + 'px',
      ...
      <div class="relative z-10 my-auto flex flex-col items-center justify-center">
        <div class="absolute h-72 w-72 animate-pulse rounded-full bg-cyan-500/5 blur-3xl"></div>

        <div class="relative flex h-64 w-64 items-center justify-center">
          <svg
            class="absolute h-full w-full -rotate-90 transform overflow-visible"
            viewBox="0 0 100 100"
          >
            <circle
              cx="50"
          ...
          <!-- 赛博猫爪 -->
          <div class="animate-float absolute flex h-36 w-36 items-center justify-center">
            <svg class="glow-cyan h-full w-full text-cyan-400" viewBox="0 0 100 100">
              <ellipse
                cx="23"
                cy="46"
                rx="7"
                ...
                :class="progress > 20 ? 'scale-100 opacity-100' : 'scale-90 opacity-25'"
              />
              <ellipse
                cx="40"
                cy="28"
                ...
                ry="13"
                class="fill-current transition-all duration-300"
                :class="progress > 40 ? 'scale-100 opacity-100' : 'scale-90 opacity-25'"
              />
              <ellipse
                cx="60"
                cy="28"
                ...
                ry="13"
                class="fill-current transition-all duration-300"
                :class="progress > 60 ? 'scale-100 opacity-100' : 'scale-90 opacity-25'"
              />
              <ellipse
                cx="77"
                cy="46"
                ...
                ry="11"
                class="fill-current transition-all duration-300"
                :class="progress > 80 ? 'scale-100 opacity-100' : 'scale-90 opacity-25'"
              />
              <path
                d="M 28,70 C 24,56 36,50 50,50 C 64,50 76,56 72,70 C 68,81 58,79 50,79 C 42,79 32,81 28,70 Z"
                class="fill-current transition-all duration-300"
                :class="progress > 10 ? 'scale-100 opacity-100' : 'scale-95 opacity-25'"
              />
            </svg>
          </div>
        </div>
        ...
        <div class="mt-8 flex flex-col items-center space-y-2">
          <div class="flex h-8 items-center">
            <span
              v-if="!isEstablished"
              class="text-glow-teal animate-pulse font-mono text-2xl tracking-[0.2em] text-cyan-300"
            >
