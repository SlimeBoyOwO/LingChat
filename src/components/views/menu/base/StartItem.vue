<template>
  <button
    v-bind="$attrs"
    class="start-item mt-[15px] cursor-pointer border-none bg-transparent p-[5px] text-justify
      ...
      ease-[cubic-bezier(0.18,0.89,0.32,1.28)] text-shadow-[0_2px_4px_rgba(0,0,0,0.3)]
      hover:not-disabled:-translate-y-2 hover:not-disabled:scale-105
      hover:not-disabled:text-[#f0f0f0]
      hover:not-disabled:text-shadow-[0_0_6px_rgba(255,255,255,0.4)] disabled:cursor-not-allowed
      disabled:opacity-50 hover:disabled:text-white
      hover:disabled:text-shadow-[0_2px_4px_rgba(0,0,0,0.5)] max-[767px]:text-left
