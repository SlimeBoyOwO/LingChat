<template>
  ...
  <div
    class="relative flex h-full w-full items-center justify-center overflow-hidden bg-[#0a0a0c]
      font-['Noto_Sans_SC',sans-serif] text-white"
  >
        ...
        >
          ...
          <div v-else-if="section.layout === 'normal'" class="mb-15 flex flex-col items-center">
            ...
            >
              ...
              <p
                class="pl-4 text-left text-[1em] leading-[1.8] font-light whitespace-nowrap
                  opacity-80"
              >
                {{ item.enName }}
              </p>
