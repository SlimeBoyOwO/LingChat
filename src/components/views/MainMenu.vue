<template>
  ...
  >
    ...
    <!-- 背景层（最底层） -->
    <div
      class="video-background absolute top-0 left-[-10%] z-[-2] h-full w-[120%] bg-[url('../../assets/images/background2.png')] bg-cover bg-center will-change-transform"
      ref="bgRef"
    ></div>
    ...
    <!-- 人物图层（位于星星之上，菜单之下） -->
    <img
      class="character-image pointer-events-none absolute top-1/2 left-1/2 z-3 h-full w-full select-none
        transform-[translate(-50%,-50%)] object-cover will-change-transform"
      ref="charRef"
