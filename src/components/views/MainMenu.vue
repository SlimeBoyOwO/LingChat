<template>
  ...
  >
    ...
    <!-- 背景层（最底层） -->
    <div
      class="video-background absolute top-0 left-[-10%] z-[-2] h-full w-[120%]
    ...
    <!-- 人物图层（位于星星之上，菜单之下） -->
    <img
      class="character-image pointer-events-none absolute top-1/2 left-1/2 z-3 max-h-full max-w-full
