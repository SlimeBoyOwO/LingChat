      ...
      >
        <div class="relative mb-6 outline-none">
          <div class="w-[180px] h-[180px] relative outline-none border-none">
            <svg class="w-full h-full -rotate-90 outline-none overflow-visible block" viewBox="0 0 100 100">
              <defs>
              ...
              <circle 
                class="fill-none stroke-white/10 stroke-[4]" 
                cx="50" cy="50" r="45" 
              />
              <circle 
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center z-10">
              <div 
                ...
                title="点击修改名称"
              >
                <span v-if="!editingLabel" class="text-base font-medium tracking-wide opacity-90 group-hover:text-[#4facfe] transition-colors">
                  {{ workLabel }}
                </span>
                <input
                  v-else
              ...
              <div class="text-5xl font-bold leading-none tabular-nums my-1 drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]">
                {{ minutes }}:{{ seconds }}
              </div>
        ...
        <div class="flex justify-between w-full pt-4 border-t border-white/10">
          ...
          <div class="flex flex-col items-center flex-1">
            ...
            <div class="flex items-center justify-center relative h-6">
              ...
              <div class="flex flex-col justify-center h-full gap-[2px]">
                <div class="flex items-center justify-center cursor-pointer opacity-60 hover:opacity-100 h-2.5 active:scale-90 transition-transform" @click="adjustWork(1)">
          ...
          <div class="flex flex-col items-center flex-1">
            ...
            <div class="flex items-center justify-center relative h-6">
              ...
              <span class="text-[11px] text-white/50 pointer-events-none ml-0.5 mr-1">m</span>
              <div class="flex flex-col justify-center h-full gap-[2px]">
                <div class="flex items-center justify-center cursor-pointer opacity-60 hover:opacity-100 h-2.5 active:scale-90 transition-transform" @click="adjustBreak(1)">
                  <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor">
                    <path d="M7 14l5-5 5 5z" />
                  </svg>
                </div>
          ...
          <div class="flex flex-col items-center flex-1">
            ...
            <div class="flex items-center justify-center relative h-6">
              ...
              <div class="flex flex-col justify-center h-full gap-[2px]">
                <div class="flex items-center justify-center cursor-pointer opacity-60 hover:opacity-100 h-2.5 active:scale-90 transition-transform" @click="adjustCycles(1)">
                  <svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor">
                    <path d="M7 14l5-5 5 5z" />
                  </svg>
                </div>
