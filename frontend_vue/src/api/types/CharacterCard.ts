...
export async function getCharacterCardCover(
  card_id: number[],
): Promise<CharacterCardCover[]> {
...
export async function getCharacterCardExtend(
  covers: CharacterCardCover[],
...
export async function getCharacterCardFull(
  card_id: number[],
): Promise<CharacterCard[]> {
...
export async function searchCharacterCards(
  card_name: string,
): Promise<CharacterCardCover[]> {
