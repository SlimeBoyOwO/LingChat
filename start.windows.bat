:: Project one-click installation and startup

@echo off
SETLOCAL ENABLEDELAYEDEXPANSION

:: Set project root directory to current script location
cd /d "%~dp0"
...
:: Try to find and use Python 3.10, 3.11, or 3.12 (priority 3.12)
SET PYTHON_EXE=
...
:RunBackend
:: 2. Run backend Python script (in a separate window, keep open)
