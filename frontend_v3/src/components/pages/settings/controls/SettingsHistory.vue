        ...
        <MenuItem title="◈ 历史对话">
            <div class="history-container">
                <div class="chat-history-container" ref="chatContainer">
                    <template v-for="(message, index) in dialogHistory" :key="message.timestamp || index">
                        <div class="message-item">
                            ...
                            >
                                <span class="name">{{ gameStore.avatar.character_name }}: </span>
                                <span class="content">
                                    {{ message.content }}
                                    <template v-if="message.motionText">({{ message.motionText }})</template>
                                </span>
                            </div>
                        </div>
