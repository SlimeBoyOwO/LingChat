...
export class EmotionController {
    ...
    constructor(DOM: EmotionDOM) {
        ...
        this.DOM.avatar.container.addEventListener("animationend", this.animationEndHandler);
    }
        ...
        if (config.avatar && config.avatar !== "none") {
            try {
                ...
                img.onerror = () => {
                    ...
                    this.DOM.avatar.img.classList.remove("loading");
                    // 设置默认头像背景
                    this.DOM.avatar.img.style.backgroundImage = "url(/api/v1/chat/character/get_avatar/正常.png)";
                };
    ...
    destroy() {
        this.DOM.avatar.container.removeEventListener("animationend", this.animationEndHandler);
    }
}
